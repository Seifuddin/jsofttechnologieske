    ...
    <section className="py-12 md:py-16 bg-white text-gray-900 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          {stats.map((stat, index) => (
            <motion.div
              ...
              whileHover={{ y: -3 }}
              className="bg-gray-50 rounded-lg border border-gray-100 p-3 text-center hover:shadow-md transition-all duration-300"
            >
        ...
        <div className="grid lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className={`group bg-white rounded-lg border ${feature.borderColor} p-3 shadow-sm hover:shadow-md transition-all duration-300`}
                >
                  <div className={`inline-flex p-1.5 rounded-lg ${feature.bgColor} mb-1.5 group-hover:scale-110 transition-transform duration-300`}>
                    {feature.icon}
                  </div>
          ...
          >
            <div className="relative rounded-xl overflow-hidden shadow-lg shadow-blue-500/10">
